...
static unsigned int gappx                  = 10; /* horiz inner gap between windows */
...
static const Key keys[] = {
	...
	{ MODKEY,                    XKB_KEY_m,		     spawn,          {.v = playpausecmd} },
	{ MODKEY,                    XKB_KEY_n,		     spawn,          {.v = nextcmd} },
	{ MODKEY,                    XKB_KEY_b,		     spawn,          {.v = prevcmd} },
	{ MODKEY|WLR_MODIFIER_SHIFT, XKB_KEY_colon,      spawn,          SHCMD("swaylock") },
